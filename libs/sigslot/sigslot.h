...
namespace sigslot {
	...
	{
	public:
        typedef typename _signal_base1<arg1_type, mt_policy>::const_iterator const_iterator;
		signal1()
		{
			;
		}
	...
	public:
        typedef typename _signal_base5<arg1_type, arg2_type, arg3_type,
            arg4_type, arg5_type, mt_policy>::connections_list::const_iterator const_iterator;
		signal5()
		{
			;
		}
